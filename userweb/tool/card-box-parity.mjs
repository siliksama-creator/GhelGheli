...
//
// کراس‌پلی: دو کاربر کنار هم صندوق باز می‌کنند. «کمیاب» در یکی و
// «نقره‌ای» در دیگری یعنی دو بازیِ متفاوت. این گارد همان‌جایی است که
// واگراییِ رده‌ها را می‌گیرد.
const webRarity = read('userweb/src/lib/cards.js');
const andRarity = read('mobile/lib/widgets/rarity_card_frame.dart');
for (const label of ['معمولی', 'کمیاب', 'نایاب', 'افسانه‌ای']) {

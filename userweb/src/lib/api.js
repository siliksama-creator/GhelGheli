...
// ═══════════════════════════════════════════════════════════════════════════
// همان چهار رنگ برای تم روشن
// ═══════════════════════════════════════════════════════════════════════════
//
// بنر «اعلان مدیریت» متن را با **همان** رنگِ اکسنت می‌نویسد، روی
// پس‌زمینه‌ای که ۱۳٪ همان رنگ است. روی سطحِ روشن نتیجه فاجعه بود:
//
//     طلایی ۱.۴۸:۱ · سبز ۱.۷۵:۱ · آبی ۲.۲۷:۱ · قرمز ۲.۴۴:۱
//
// و این تنها راهی است که مدیریت می‌تواند به همهٔ کاربران پیام بدهد —
// یعنی مهم‌ترین متنِ صفحهٔ چت، ناخوان.
//
// همان روشِ رنگِ نام: hue و اشباع ثابت، فقط روشنایی تا ≥۴.۷:۱ پایین.
// «طلایی» هنوز طلایی است.
export const PIN_COLORS_LIGHT = {
  gold: '#885F00', green: '#197554', blue: '#0762D3', red: '#C90A0A',
};

/** رنگِ اکسنت متناسب با تمِ فعال. */
export function pinColor(accent, theme) {
  const table = theme === 'light' ? PIN_COLORS_LIGHT : PIN_COLORS;
  return table[accent] || table.gold;
}

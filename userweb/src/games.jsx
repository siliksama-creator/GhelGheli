              ...
              {g.winner === 'DRAW' ? (
                <span style={{ color: '#94A3B8', background: 'rgba(148,163,184,0.12)', padding: '5px 14px', borderRadius: 99 }}>
                  {/* ── تساوی (دوئلِ کارت؛ مهر ۱۴۰۵) ──────────────────
                      ⚠️ پنالتی دیگر مساوی نمی‌شود: بعد از ۵ ضربهٔ هر طرف،
                      در صورتِ برابری راندهای اضافه ادامه پیدا می‌کنند تا
                      برنده پیدا شود. این شاخه برای بازی‌هایی است که واقعاً
                      می‌توانند مساوی شوند (دوئلِ کارت).

    ...
    const onSettlement = d => {
      setG(prev => {
        ...
        const next = {
          ...
          // ⚠️ پنالتی دیگر به این شاخه نمی‌رسد: آن بازی تساوی ندارد و بعد
          //    از ۵ ضربهٔ هر طرف با راندهای اضافه به برنده می‌رسد. این
          //    مسیر برای بازی‌هایی زنده است که واقعاً مساوی می‌شوند.

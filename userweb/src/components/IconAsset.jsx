...
const PATHS = {
  ...
  // ── دوئل طوفان: شبدر (شانس)، ساعت (وقت اضافه)، ترازو (تساوی) ──
  clover: <><path d="M12 13c-2.5 0-4-1.6-4-3.7A2.3 2.3 0 0 1 10.3 7c1 0 1.7.6 1.7 1.6V13Z" /><path d="M12 13c2.5 0 4-1.6 4-3.7A2.3 2.3 0 0 0 13.7 7c-1 0-1.7.6-1.7 1.6V13Z" /><path d="M12 12c0-2.5 1.6-4 3.7-4A2.3 2.3 0 0 1 18 10.3c0 1-.6 1.7-1.6 1.7H12Z" /><path d="M12 12c0 2.5-1.6 4-3.7 4A2.3 2.3 0 0 1 6 13.7c0-1 .6-1.7 1.6-1.7H12Z" /><path d="M12 13v4.5c0 1.4-1 2.5-2.5 2.8" /></>,
  clock: <><circle cx="12" cy="12" r="8.5" /><path d="M12 7.5V12l3 2" /></>,
  scale: <><path d="M12 4v16M7 20h10M12 4 5 6m7-2 7 2" /><path d="m5 6-2.5 6a2.6 2.6 0 0 0 5 0L5 6Zm14 0-2.5 6a2.6 2.6 0 0 0 5 0L19 6Z" /></>,
  // «نشان» و «جعبهٔ آیتم» — برای «لحظهٔ جایزه» (گذر نبرد و آیتم فروشگاه).
  // از قبل در `ASSETS` به‌صورت تصویر بودند ولی در `PATHS` نبودند؛ حالا هر دو
  // شکل را دارند تا هم `SvgIcon` و هم `AssetIcon` کار کنند و `icon-parity`
  // با `ui_icon.dart` برابر بماند.
  medal: <><circle cx="12" cy="15" r="4.6" /><path d="M8.7 10.9 6 3h4.1l1.9 5.3L13.9 3H18l-2.7 7.9" /><path d="m10 15.4 1.5 1.5 2.7-2.8" /></>,
  item: <><path d="m12 3 8.5 4.7v8.6L12 21l-8.5-4.7V7.7L12 3Z" /><path d="M3.5 7.7 12 12.3l8.5-4.6M12 12.3V21" /></>,
};

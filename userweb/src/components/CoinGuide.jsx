...
export default function CoinGuide({ open, onToggle, economy }) {
  ...
  const RULES = [
    ...
    ['calendar', text('coinGuide.quota',
      ...
      { qLow: quota100, stakeLowText: stakeLabel(stakeLow),
        qHigh: quota1000, stakeHighText: stakeLabel(stakeHigh) })],
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '11px', padding: '11px 14px 9px' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* دورِ ۳۳ — این پاراگراف سه سطر بود و روی گوشیِ ۴۱۲px کلِ بلوک
              ...
              لیگ) زیرِ خطِ تا می‌افتاد. قیدِ مالک: «اطلاعات کلیدی صفحهٔ
              لیگ بدون اسکرول و چشم‌گیر باشد».
              محتوا حذف نشد؛ آنچه جدول خودش می‌گوید («مساوی و باخت هم سکه
              دارند» — دو ردیفِ پایینِ همان جدول) از متن برداشته شد. */}
          <span style={{ display: 'block', fontSize: '12.5px', lineHeight: 1.55, color: 'rgba(255,255,255,0.9)' }}>
            ...
            <b style={{ color: '#FFD166' }}>بازی مقابل حریف واقعی</b> به دست می‌آید.
          </span>
        </div>
      </div>

...
class HeroLogo extends StatelessWidget { const HeroLogo({super.key}); @override Widget build(BuildContext c) => Column(mainAxisSize: MainAxisSize.min, children: [Container(width: 150, height: 190, padding: const EdgeInsets.all(6), decoration: BoxDecoration(borderRadius: BorderRadius.circular(28), color: Colors.white, boxShadow: [BoxShadow(color: Colors.tealAccent.withOpacity(.22), blurRadius: 45)]), child: Image.asset('assets/brand/logo.png', fit: BoxFit.contain)), const SizedBox(height: 14), const Text('قلقلی', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900))]); }

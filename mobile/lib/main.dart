...
Future<void> showPublicProfile(BuildContext context, ApiClient api, Object? userId) async {
  ...
  showModalBottomSheet(context: context, showDragHandle: true, builder: (_) => FutureBuilder(
    ...
    builder: (c, s) {
      ...
      return Directionality(textDirection: TextDirection.rtl, child: Padding(padding: const EdgeInsets.all(18), child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [

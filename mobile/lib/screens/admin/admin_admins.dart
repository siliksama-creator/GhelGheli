        ...
        FormSection(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: const InputDecoration(
                  labelText: 'نقش',
                  helperText: '«مدیر کل» همه‌چیز را می‌بیند و تغییر می‌دهد؛ «پشتیبان» عملیات روزمره (کاربران، تیکت، محتوا، امتیاز) را دارد ولی مدیریت ادمین‌ها را نه؛ «ناظر» فقط داشبورد و تیکت‌ها را می‌بیند و چیزی را تغییر نمی‌دهد.',
                  helperMaxLines: 6,
              ),
              items: const [

...
class GameSession extends ChangeNotifier {
  ...
  int coinsAwarded = 0;
  String? coinsWinner;
  /// ── تساوی (دوئلِ کارت؛ مهر ۱۴۰۵) ──
  ///
  /// ⚠️ پنالتی دیگر مساوی نمی‌شود: بعد از ۵ ضربهٔ هر طرف، در صورتِ برابری
  ///    راندهای اضافه ادامه پیدا می‌کنند تا برنده پیدا شود. این مسیر فقط
  ///    برای بازی‌هایی زنده است که واقعاً می‌توانند مساوی شوند (دوئلِ کارت).
  ///
  ...
  ///   • پنالتی: تابلوی امتیاز، شبکهٔ ۶ ناحیه و نقاشِ زمین.
  ///

...
const COIN_TABLE = Object.freeze({
  card_duel: Object.freeze({ 100: 2, 1000: 20 }),
  penalty:   Object.freeze({ 100: 1, 1000: 10 }),
  memory:    Object.freeze({ 100: 1, 1000: 10 }),
});
...
/** پاداشِ سکهٔ یک بازی در یک سطحِ شرط؛ ۰ یعنی این ترکیب سکه ندارد. */

...
const SOURCES = Object.freeze([
  ...
  'signup_gift',
  // امتیازِ کارت‌های صندوق (دورِ ۲۶). جدا از `photo_card` نگه داشته شده
  // تا بشود سهمِ امتیازِ خریداری‌شده را از امتیازِ کارتِ فیزیکی تفکیک
  // کرد. CHECK متناظر در مایگریشن ۰۷۲.
  'card_box',

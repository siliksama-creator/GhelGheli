// ============================================================================
//  نگه‌داریِ چت — فقط ۲۰۰ پیامِ آخر
// ============================================================================
//
// ── خواستهٔ مالک ──
//
//   «کل کاربرا بیشتر از ۲۰۰ چت مجموع نگه داری نشه — چون این سیستم پیام
//    آماده داره، اصلا چت اونقدر مهم نیست»
//
// یعنی سقف **سراسری** است، نه به‌ازای هر کاربر: کلِ جدول ۲۰۰ ردیف.
//

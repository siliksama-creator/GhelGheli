...
const DEFAULT_COPY = Object.freeze({
  ...
  update: {
    ...
    installing: 'در حال نصب… اگر اندروید دکمهٔ به‌روزرسانی را نشان داد، همان را بزن.',
    allowInstall: 'اندروید یک‌بار باید اجازهٔ نصب را به خودِ قلقلی بدهد. صفحهٔ بعد فقط یک کلید است؛ روشن کن و برگرد. نصب خودش ادامه پیدا می‌کند.',
    allowButton: 'ادامهٔ نصب',
    install: 'نصب',
    retry: 'تلاش مجدد',

...
const TAB_IDS = Object.freeze([
  ...
  // فهرست می‌افتاد.
  'ledger',
  // برنامه‌های پیشنهادی — خواستهٔ مالک (۲۶ شهریور). همان دلیلِ `ledger`:
  // این ردیف در شیتِ «بیشتر» هر دو کلاینت هست؛ بدونِ آمدنش در `TAB_IDS`,
  // `normalizeTabOrder` بی‌صدا دورش می‌ریخت و ادمین نمی‌توانست از پنل
  // جابه‌جایش کند (و فکر می‌کرد پنل کار نمی‌کند).
  'apps',
]);

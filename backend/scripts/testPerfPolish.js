...
// قرصِ راهنما: گوشهٔ پایینِ راست (نه مرکزِ محتوا) و پهن‌تر از دورِ قبل.
//
// چرا عدد از ۱۴۸ به ۲۳۲ رسید (۲۹ شهریور): با ۱۴۸px جملهٔ واقعیِ صفحه جا
// نمی‌شد و نسخهٔ قبلی به‌جای کوتاه‌کردنِ متن، **همهٔ** برچسب‌های بلندتر از
// ۱۶ نویسه را با «ادامه پایین‌تر» عوض می‌کرد — یعنی هیچ صفحه‌ای پیامِ
// خودش را نمی‌داد («چه چیزی را دارم از دست می‌دهم»). حالا همان جمله با
// «…» کوتاه می‌شود، و ۲۳۲px هم‌اندازهٔ سقفِ وب/پنل است (`max-width:
// min(230px, …)` در CSS). مکان (گوشهٔ پایینِ راست) عوض نشده است.
ok(/right:\s*18/.test(scrollHint) && /maxWidth:\s*232/.test(scrollHint),
  'قرص راهنمای اسکرول از مرکز محتوا به گوشهٔ کم‌مزاحمت منتقل شده');
ok(!/label\.length\s*>\s*16/.test(scrollHint),
  'جملهٔ واقعیِ صفحه جایگزین نمی‌شود (متنِ جانشینِ «ادامه پایین‌تر» برنگشته)');
ok(/0\.62/.test(scrollHint), 'ضریبِ پرشِ قرص با وب/پنل یکی است (۰٫۶۲ صفحه)');

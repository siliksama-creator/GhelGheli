 ...
 *   npm run apk:publish -- ./app.apk 1.1.20 --no-url --no-min   # فقط آرشیو
 *
 * اختیارها:
 ...
 *   --no-min        حداقلِ نسخه را بالا نبر (دیالوگِ آپدیت نشان داده نشود)
 *
...
const form = [
  ...
  '-F', `promoteMinVersion=${has('--no-min') ? 'false' : 'true'}`,

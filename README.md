...
- پنل مدیریت: `Admin / Ali@0142`
- اپلیکیشن اندروید برای تست بدون پیامک: `Admin / Ali@0142`

در اپ Flutter یک حالت «ورود مدیر» با نام کاربری Admin و رمز Ali@0142 هم اضافه شده است.
...
- مدیر می‌تواند تا ۳۰ جایزه تعریف کند.
- هر جایزه نام، عکس، امتیاز مورد نیاز، نوع و توضیح دارد.
- نوار پیشرفت اپ کاربر براساس جایزه بعدی محاسبه می‌شود.
- ورود تست مدیر داخل اپ: `Admin / Ali@0142`؛ رمز داخل دکمه اپ hardcode نشده و باید تایپ شود.

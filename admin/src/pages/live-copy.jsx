...
const GROUP_LABEL = {
  ...
  // گروهِ «جشنِ دریافت»: متنِ همان کارتی که بعد از گرفتنِ ماموریت/جایزهٔ
  // گردونه/پاداشِ زنجیره وسطِ صفحه می‌آید. اسمِ فارسی عمداً همان چیزی است
  // که کاربر می‌بیند («دریافت شد»)، نه اسمِ فنیِ گروه.
  reward: 'جشنِ دریافت (دریافت شد)',
};

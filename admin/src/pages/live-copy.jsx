...
const GROUP_LABEL = {
  ...
  // گروهِ «لحظهٔ جایزه» (۲۹ شهریور): متنِ کارتی که بعد از گرفتنِ ماموریت/
  // جایزهٔ گردونه/پاداشِ زنجیره/گذرِ نبرد/خریدِ فروشگاه/پایانِ بازی وسطِ
  // صفحه می‌آید — یکی برای همهٔ مسیرها. اسمها همان چیزی است که کاربر
  // می‌بیند («دریافت شد»، «این دور تمام شد»)، نه اسمِ فنیِ گروه.
  reward: 'لحظهٔ جایزه (دریافت و نتیجه)',
  // تبِ «صندوق سکه» در صفحهٔ لیگ (۱۴۰۵/۰۷/۰۲): سکهٔ موقتِ لیگ در برابرِ
  // سکهٔ بدست‌آمده، فرمِ واریز، و بخشِ «بزودی»ِ جوایزِ مخصوص سکه.
  vault: 'صندوق سکه',
  // تبِ «معرف‌های برتر تا کنون» و «لیگ معرف‌ها» در صفحهٔ دعوت از دوستان
  // (۴ مهر ۱۴۰۵). اسمِ گروه به زبانِ کاربر است، نه اسمِ جدول.
  inviteLeague: 'لیگ معرف‌ها',
};

...
// `ACCENTS_LIGHT` حذف شد — پنل و اپ هر دو تک‌تم (تیره) شدند، پس
// پیش‌نمایش فقط یک نسخه دارد.
...
function PinnedMessageCard({ request }) {
  ...
  // هر انتخابگری قوی‌تر است، پس هیچ قانونِ CSSی نمی‌تواند عوضش کند.
  // فقط متغیرِ ورودی می‌دهیم و `--pin` را theme.css می‌سازد.
  const colorVars = {
